            ...
            <div class="container">
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-3 logo-holder">
                        <!-- ============================================================= LOGO ============================================================= -->
                        <div class="logo"> <a href="home.html"> <img src="{{ asset('assets') }}/website/images/logo.png"
                                    alt="logo"> </a> </div>
                        <!-- /.logo -->
                        <!-- ============================================================= LOGO : END ============================================================= -->
                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-xs-4">
                                                <div class="image"> <a href="detail.html"><img
                                                            src="{{ asset('assets') }}/website/images/cart.jpg"
                                                            alt=""></a> </div>
                                            </div>
                                            <div class="col-xs-7">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-xs-12 col-sm-6 col-md-4 col-menu banner-image">
                                                            <img class="img-responsive"
                                                                src="{{ asset('assets') }}/website/images/banners/top-menu-banner.jpg"
                                                                alt=""> </div>
                                                        <!-- /.yamm-content -->
                                                    </div>
                                                </div>
                                                ...
                                                <div class="yamm-content">
                                                    <div class="row">
                                                        ...
                                                        <div
                                                            ...
                                                            <a href="#"><img alt=""
                                                                    src="{{ asset('assets') }}/website/images/banners/banner-side.png"></a>
                                                        </div>
                                                    </div>
                                                    <!-- /.row -->
                                                </div>
